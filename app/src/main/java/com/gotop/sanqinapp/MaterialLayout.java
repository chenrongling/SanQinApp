...
public class MaterialLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_mycolor, Color.WHITE);//Color.LTGRAY
        ...
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_alpha2, DEFAULT_ALPHA);
